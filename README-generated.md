...
- [rwxd/wiki](https://github.com/rwxd/wiki) ([v1.3.63](https://github.com/rwxd/wiki/releases/tag/v1.3.63), 5 days ago) - Notes on many things
...
- [use regex to include/exclude interfaces](https://github.com/wobcom/transceiver-exporter/pull/9) on [wobcom/transceiver-exporter](https://github.com/wobcom/transceiver-exporter) (6 days ago)
...
- [Add the possibility to use regex for zones](https://github.com/akquinet/powerdns-api-proxy/pull/3) on [akquinet/powerdns-api-proxy](https://github.com/akquinet/powerdns-api-proxy) (4 weeks ago)

...
- [netbox-community/netbox](https://github.com/netbox-community/netbox) ([v4.0.8](https://github.com/netbox-community/netbox/releases/tag/v4.0.8), 2 days ago) - The premier source of truth powering network automation. Open source under Apache 2. Public demo: https://demo.netbox.dev
- [akquinet/powerdns-api-proxy](https://github.com/akquinet/powerdns-api-proxy) ([v1.3.11](https://github.com/akquinet/powerdns-api-proxy/releases/tag/v1.3.11), 5 days ago) - API proxy for powerdns implementing multiple tokens and fine access control.

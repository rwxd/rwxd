...
- [rwxd/wiki](https://github.com/rwxd/wiki) ([v1.3.50](https://github.com/rwxd/wiki/releases/tag/v1.3.50), 2 days ago) - Notes on many things
- [akquinet/powerdns-api-proxy](https://github.com/akquinet/powerdns-api-proxy) ([v1.0.0](https://github.com/akquinet/powerdns-api-proxy/releases/tag/v1.0.0), 3 days ago) - This is an api proxy for powerdns implementing multiple tokens and fine access control.
- [rwxd/ankigengpt](https://github.com/rwxd/ankigengpt) ([v1.2.2](https://github.com/rwxd/ankigengpt/releases/tag/v1.2.2), 6 days ago) - Convert your text into flashcards for use in Anki
...
- [fix: made source optional and non default](https://github.com/rwxd/ankigengpt/pull/43) on [rwxd/ankigengpt](https://github.com/rwxd/ankigengpt) (6 days ago)

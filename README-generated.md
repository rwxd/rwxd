...
- [pdreker/fritz_exporter](https://github.com/pdreker/fritz_exporter) ([fritzexporter-v2.5.0](https://github.com/pdreker/fritz_exporter/releases/tag/fritzexporter-v2.5.0), 5 days ago) - Prometheus exporter for Fritz!Box home routers
- [cupcakearmy/autorestic](https://github.com/cupcakearmy/autorestic) ([v1.8.1](https://github.com/cupcakearmy/autorestic/releases/tag/v1.8.1), 5 days ago) - Config driven, easy backup cli for restic.
...
- [fix(unlock cmd): ignore process if its the current id](https://github.com/cupcakearmy/autorestic/pull/360) on [cupcakearmy/autorestic](https://github.com/cupcakearmy/autorestic) (6 days ago)

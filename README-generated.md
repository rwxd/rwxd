...
- [netbox-community/netbox](https://github.com/netbox-community/netbox) ([v3.7.7](https://github.com/netbox-community/netbox/releases/tag/v3.7.7), today) - The premier source of truth powering network automation. Open source under Apache 2. Public demo: https://demo.netbox.dev
- [IsmaelMartinez/teams-for-linux](https://github.com/IsmaelMartinez/teams-for-linux) ([v1.4.34](https://github.com/IsmaelMartinez/teams-for-linux/releases/tag/v1.4.34), today) - Unofficial Microsoft Teams for Linux client

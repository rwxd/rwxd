...
- [IsmaelMartinez/teams-for-linux](https://github.com/IsmaelMartinez/teams-for-linux) ([v1.4.28](https://github.com/IsmaelMartinez/teams-for-linux/releases/tag/v1.4.28), 1 day ago) - Unofficial Microsoft Teams for Linux client
- [akquinet/powerdns-api-proxy](https://github.com/akquinet/powerdns-api-proxy) ([v1.3.7](https://github.com/akquinet/powerdns-api-proxy/releases/tag/v1.3.7), 4 days ago) - This is an api proxy for powerdns implementing multiple tokens and fine access control.

...
- [IsmaelMartinez/teams-for-linux](https://github.com/IsmaelMartinez/teams-for-linux) ([v1.6.1](https://github.com/IsmaelMartinez/teams-for-linux/releases/tag/v1.6.1), 2 days ago) - Unofficial Microsoft Teams for Linux client
- [netbox-community/netbox](https://github.com/netbox-community/netbox) ([v4.0.5](https://github.com/netbox-community/netbox/releases/tag/v4.0.5), 3 days ago) - The premier source of truth powering network automation. Open source under Apache 2. Public demo: https://demo.netbox.dev

...
- [akquinet/powerdns-api-proxy](https://github.com/akquinet/powerdns-api-proxy) ([v1.3.8](https://github.com/akquinet/powerdns-api-proxy/releases/tag/v1.3.8), 2 days ago) - API proxy for powerdns implementing multiple tokens and fine access control.
- [IsmaelMartinez/teams-for-linux](https://github.com/IsmaelMartinez/teams-for-linux) ([v1.5.2](https://github.com/IsmaelMartinez/teams-for-linux/releases/tag/v1.5.2), 4 days ago) - Unofficial Microsoft Teams for Linux client

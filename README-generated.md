...
- [elastic/beats](https://github.com/elastic/beats) ([v8.14.2](https://github.com/elastic/beats/releases/tag/v8.14.2), 4 days ago) - :tropical_fish: Beats - Lightweight shippers for Elasticsearch &amp; Logstash 
- [IsmaelMartinez/teams-for-linux](https://github.com/IsmaelMartinez/teams-for-linux) ([v1.7.5](https://github.com/IsmaelMartinez/teams-for-linux/releases/tag/v1.7.5), 6 days ago) - Unofficial Microsoft Teams for Linux client
- [netbox-community/netbox](https://github.com/netbox-community/netbox) ([v4.0.6](https://github.com/netbox-community/netbox/releases/tag/v4.0.6), 2 weeks ago) - The premier source of truth powering network automation. Open source under Apache 2. Public demo: https://demo.netbox.dev

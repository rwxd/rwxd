...
- [akquinet/powerdns-api-proxy](https://github.com/akquinet/powerdns-api-proxy) ([v1.1.0](https://github.com/akquinet/powerdns-api-proxy/releases/tag/v1.1.0), 1 day ago) - This is an api proxy for powerdns implementing multiple tokens and fine access control.
...
- [rwxd/wiki](https://github.com/rwxd/wiki) ([v1.3.50](https://github.com/rwxd/wiki/releases/tag/v1.3.50), 2 weeks ago) - Notes on many things
...
- [Add the possibility to use regex for zones](https://github.com/akquinet/powerdns-api-proxy/pull/3) on [akquinet/powerdns-api-proxy](https://github.com/akquinet/powerdns-api-proxy) (6 days ago)
